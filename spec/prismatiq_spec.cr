...
describe "concurrent palette extraction" do
  it "handles multiple concurrent palette extractions safely" do
    ...
    10.times do
      spawn do
        begin
          options = PrismatIQ::Options.new(color_count: 5, quality: 5)
  ...
  it "produces consistent results under concurrent access" do
    ...
    options = PrismatIQ::Options.new(color_count: 3, quality: 1)
    ...
    20.times do
      spawn do
        opts = PrismatIQ::Options.new(color_count: 3, quality: 1)
